...
python3 -m DAForLinGen.experiments.fit_factors_babylm \
...
For testing, add --end_index 10 to the line

Outputs will be in the directory:

{output_dir}/{analysis_name}/f"factors_{factors_name}/

Profiler output: {output_dir}/{analysis_name}/profiler_output
"""
...
from DAForLinGen.models.babylm import get_modules_for_babylm_all_linear
...
def main():
    ...
    module_names = get_modules_for_babylm_all_linear()
